...
public class Day_18 {
    ...
    private static class World
    {
        ...
        public static boolean isActive(int x, int y, int z, int w)
        {
        ...
        public static int getNeighborActiveCount(int x, int y, int z, int w)
        {
            int active = 0;
